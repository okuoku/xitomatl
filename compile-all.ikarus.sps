...
(import
  ...
  (only (xitomatl fmt (0 5)))
  (only (xitomatl fmt base (0 5)))
  (only (xitomatl fmt c (0 5)))
  (only (xitomatl fmt color (0 5)))
  (only (xitomatl fmt column (0 5)))
  (only (xitomatl fmt let-optionals*))
  (only (xitomatl fmt pretty (0 5)))
  (only (xitomatl fmt srfi-33))
  (only (xitomatl fmt srfi-69))
  (only (xitomatl fmt unicode (0 5)))
  (only (xitomatl fuego))
