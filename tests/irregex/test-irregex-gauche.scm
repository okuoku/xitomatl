...
(define rxmatch-start irregex-match-start)
(define rxmatch-end irregex-match-end)
...
(define (rxmatch-after m . o)
  (substring (irregex-match-string m) (apply irregex-match-end m o)))

(define (rxmatch-before m . o)
  (substring (irregex-match-string m) 0 (apply irregex-match-start m o)))
